  ...
  return (
    <main className="min-h-screen  w-full bg-[#ffffff] flex items-center justify-center px-4 font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-[-20%] right-[-10%] w-[500px] h-[500px] rounded-full bg-[#ffb3d9] opacity-20 blur-[120px]" />
        <div className="absolute bottom-[-20%] left-[-10%] w-[400px] h-[400px] rounded-full bg-[#ff79c6] opacity-10 blur-[100px]" />
      </div>
          ...
          <form action={formAction} className="flex flex-col gap-4">
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              <div className="relative mt-0.5 flex-shrink-0">
                ...
                />
                <div className="w-4 h-4 rounded-[5px] border border-[#f0f0f0] bg-[#f0f0f0]/50 peer-checked:bg-[#ff79c6] peer-checked:border-[#ff79c6] transition-all duration-200" />
                <svg
              ...
              <span className="text-xs text-[#171717]/50 leading-relaxed">
                I agree to the{" "}
                <a href="/terms" className="text-[#ff79c6] hover:underline">
                  Terms of Service
                </a>{" "}
                and{" "}
                <a href="/privacy" className="text-[#ff79c6] hover:underline">
                  Privacy Policy
                </a>
              </span>
            </label>
            ...
            <button
              type="submit"
              className="mt-1 w-full py-3 rounded-xl bg-[#ff79c6] hover:bg-[#ff79c6]/90 active:scale-[0.98] text-white text-sm font-semibold tracking-wide shadow-lg shadow-[#ff79c6]/30 transition-all duration-200"
            >
              Create Account
            </button>
          </form>
